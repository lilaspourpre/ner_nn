...
class RNNModel(Model):
    def __init__(self, session, outputs, x, output_size, seqlen, max_seq_len, tags):
        super().__init__()
    ...
    def batch_predict(self, list_of_vectors):
        array_of_vectors = np.array(complement_data(list_of_vectors, self.max_seq_len), dtype='float32')
